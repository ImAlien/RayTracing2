/*
 * @Author: Alien
 * @Date: 2023-03-03 11:01:55
 * @LastEditors: Alien
 * @LastEditTime: 2023-03-04 11:32:49
 */
 ...
 public:
  ...
  Color3f Li(const Scene* scene, Sampler* sampler, const Ray3f& ray) const override {
    ...
    while (true) {
      ...
      for (auto mesh :scene->getEmitters()){
        auto light = mesh->getEmitter();
          EmitterQueryRecord lRec(its.p);
          lRec.uv = its.uv;
          Color3f Li = light->sample(mesh, lRec, sampler);
